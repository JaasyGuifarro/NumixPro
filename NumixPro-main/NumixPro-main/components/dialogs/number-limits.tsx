    ...
    >
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <h3 className="text-lg font-semibold">Límites actuales</h3>
          ...
          {isLoading ? (
            ...
            <p className="text-gray-400 text-center py-4">No hay límites establecidos</p>
          ) : (
            <div className="space-y-2">
              {limits.map((limit) => {
                const remaining = limit.max_times - limit.times_sold
                return (
                  <div key={limit.id} className="bg-white/5 p-3 rounded-lg flex justify-between items-center">
                    <div>
                      <span className="text-xl font-bold">{limit.number_range}</span>
